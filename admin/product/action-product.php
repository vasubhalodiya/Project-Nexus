...
if(isset($_POST["insert"]))
{
    ...
    $query = "insert into product(proimage, proname, proprice, procolor, prosize, proquantity, prostockstatus, prodesc) values('$folder','$proname',' $proprice',' $procolor',' $prosize','$proquantity','$prostockstatus',' $prodesc')";
    echo $query;
