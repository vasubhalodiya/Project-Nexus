...
<html lang="en">
    <head>
        ...
        <title>Admin Setting - Nexus</title>
                        ...
                        <div class="sidebar-links">
                            <ul>
                                <a href="admin-setting.html">
                                    <li class="up-border sidebar-link-menu active">
            ...
            <div class="content-main-section active">
                <div class="content-child-section">
                    <div class="cnt-navbar">
                        <div class="cnt-path">
                            <h6><a href="admin-dashboard.html">Admin</a><img src="../images/Chevron Right admin.svg" alt=""><a class="path-active">Setting</a></h6>
                        </div>
