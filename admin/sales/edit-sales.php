...
$salesid = $_REQUEST['id'];
$qry2 = "select * from sales where salesid='$salesid'";
            ...
            <div class="cnt-main-add">
                <div class="cnt-adding">
                    <div class="cnt-adding-head edit-cnt-adding-head">
                        <h4>Add Sales</h4>
                        <a href="admin-sales.php">Back to Home</a>
                    </div>
                    <div class="cnt-adding-form all-center">
                        <form action="update-sales.php" method="post">
                        <?php
                            ...
                            echo "<div class='cnt-adding-main-part'>
                                    <div class='cnt-adding-part'>
                                        <div class='cnt-adding-field'>
                                            <h5>Sales Name</h5>
                                            <input type='text' placeholder='Enter name' name='salesname' value='$row[salesname]'>
                                        </div>
                                        <div class='cnt-adding-field'>
                                            <h5>Sales Total</h5>
                                            <input type='text' placeholder='Enter total' name='salestotal' value='$row[salestotal]'>
                                        </div>
                                    </div>
                                    <div class='cnt-adding-part'>
                                        <div class='cnt-adding-field'>
                                            <h5>Sales Quantity</h5>
                                            <input type='text' placeholder='Enter quantity' name='salesqty' value='$row[salesqty]'>
                                        </div>
                                        <div class='cnt-adding-field'>
                                            <h5>Sales Date</h5>
                                ...
                                <div class='update-form-btn'>
                                    <div class='update-form-btn-off'>
                                        <a href='admin-sales.php'>Cancle</a>
                                    </div>
