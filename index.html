            ...
            <div class="navbar">
                <!-- <div class="container"> -->
                    <div class="navbar-content">
                        ...
                        <div class="nav-menu">
                            <ul>
                                <a href="index.html" class="nav-links active"><li>Home</li></a>
                                <a href="shop.html" class="nav-links"><li>Shop</li></a>
                                <a href="brands.html" class="nav-links"><li>Brands</li></a>
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-3 col-md-6 col-sm-6">
                                    <a href="#">
                                        <div class="best-card">
                                            <div class="best-card-img">
                                                <img src="images/tshirt 4.png" alt="">
                                                <!-- <div class="best-card-btn">
                                                    <a href="#" class="view-dtl">View Details</a>
                                                    <a href="#" class="add-cart">Add to Cart</a>
                                                </div> -->
                                            ...
                                            <div class="col-lg-4">
                                                <div class="footer-links">
                                                    ...
                                                    <ul>
                                                        ...
                                                        <!-- temporary -->
                                                        <a href="admin/admin-dashboard.html"><li>Admin</li></a>
                                                    </ul>
                                                </div>
                                            </div>
                                            <div class="col-lg-4">
