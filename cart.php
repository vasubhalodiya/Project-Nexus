                                                        ...
                                                        <div class='cart-card-child-part'>
                                                            <div class='cart-card-increment-decrement'>
                                                                <div class='cart-plus-minus'>
                                                                    ...
                                                                    <input type='text' name='qty' min='0' class='qty form-control' value='$value[proqty]'/>
                                                                    <button class='cart-qty-plus' type='button' value='+'>+</button>
                                                                </div>
                                                            </div>
                                                            <div class='cart-card-close'>
                                                                <form action='managecart.php' method='POST'>
                                                                    <button name='Remove_Item' class='btn btn-sm btn-outline-danger'><img src='images/close.svg' alt=''></button>
